...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            <h1>Descripcion de Paquete</h1>
            <p class="lead">Informacion estimada del paquete</p>
        </div>
        <div class="container" ng-app = "cartApp">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <p>
                    <strong>Destino</strong> : ${product.productManufacturer}
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <strong>Linea Aerea</strong> : ${product.productCondition}
                    </p>
